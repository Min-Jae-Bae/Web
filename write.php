...
<body id="target">
    ...
    <form action="process.php" method="post">    
        ...
        <input type="text" class="form-control" name="title" id="form-author" placeholder="작성자를 적어주세요">
        </div>    

        <div class="form-group">
        <label for="form-author">작성자</label>
        <textarea class="form-control" rows="10" name="title" id="form-author" placeholder="본문을 적어주세요"></textarea>
        </div>    
